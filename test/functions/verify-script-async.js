...
describe('verifyScriptAsync', () => {
  it('valid', async () => {
    ...
    await pass([9, 0, 0, 0, 0, 0, 0, 0, 0, 1, OP_BIN2NUM])
    await pass([4, 128, 0, 0, 1, OP_BIN2NUM, OP_1NEGATE, OP_EQUAL])
    await pass([7, 0, 0, 0, 0, 0, 0, 0, OP_BIN2NUM, OP_0, OP_EQUAL])
    await pass([5, 129, 0, 0, 0, 0, OP_BIN2NUM])
    await pass([OP_1, OP_16, OP_NUM2BIN])
